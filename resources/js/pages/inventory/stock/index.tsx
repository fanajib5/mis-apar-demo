                        ...
                        <table className="w-full text-left text-sm">
                            <thead>
                                <tr className="border-b">
                                    ...
                                    <th className="py-2 px-1">Current Stock</th>
                                    <th className="py-2 px-1">Cost Price</th>
                                    <th className="py-2 px-1">Selling Price</th>
                                </tr>
                            </thead>
                            <tbody>
                                {products.map((p) => (
                                    <tr key={p.id} className="border-b hover:bg-muted/50">
                                        ...
                                        <td className="py-2 px-1">
                                            <span className={`font-semibold ${p.current_stock <= 3 ? 'text-red-600' : ''}`}>
                                                {p.current_stock}
                                            </span>
                                        </td>
                                        <td className="py-2 px-1">Rp {Number(p.cost_price).toLocaleString()}</td>
                                        <td className="py-2 px-1">Rp {Number(p.selling_price).toLocaleString()}</td>
                                    </tr>
                                ))}
